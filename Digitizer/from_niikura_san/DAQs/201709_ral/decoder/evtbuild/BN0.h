...
// Wed Sep 20 21:35:46 2017 by ROOT version 6.08/06
// from TTree tree0/Tree for Board #0
// found on file: root/run1010.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual Double_t GetTiming(ULong64_t jevent);
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root/run1010.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root/run1010.root");
      }
