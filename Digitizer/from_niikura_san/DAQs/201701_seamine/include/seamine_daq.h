...
#define FIRST_CONFIG_FILE   "/home/daq/work/seamine_daq/WaveDumpConfig1.txt"
#define SECOND_CONFIG_FILE  "/home/daq/work/seamine_daq/WaveDumpConfig2.txt"
...
#define ALL_OUTPUT_NUM 1    /* added by momiyama on 170121 for test output in one file */
...
typedef struct WaveDumpRun_t {
    ...
    FILE *fout[MAX_CH];
    FILE *fout2[MAX_CH];  //added by momiyama on 170121 for test use
    FILE *fout3[ALL_OUTPUT_NUM];  //added by momiyama on 170121 for test use
} WaveDumpRun_t;
