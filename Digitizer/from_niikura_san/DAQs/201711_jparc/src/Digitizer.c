...
////end of DAQ setup
    ...
    //ch 0
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1028,0x1);  //dynamic range,1=0.5Vpp
    //  ret |= CAEN_DGTZ_WriteRegister(handle,0x1080,0x20612f0f);  //for negative
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1080,0x20112f0f);  //for negative 
    ret |= CAEN_DGTZ_WriteRegister(handle,0x10c4,0x3fff); //fine gain
    
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1038,0x3e8); //pre trigger 
    
    ret |= CAEN_DGTZ_WriteRegister(handle,0x105c,0xfa); // trap. rise time
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1060,0x7d); // trap. flat top
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1064,0x25); // peaking time 
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1068,0x4e2); // decay time
    //ret |= CAEN_DGTZ_WriteRegister(handle,0x1068,0x0380); // decay time 
    
    ret |= CAEN_DGTZ_WriteRegister(handle,0x106c,0x40); //trig. threshold
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1058,0x24);  //input rise time 
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1228,0x1);  //dynamic range,0=2Vpp
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1280,0x20112f0f);  //for negative
    ret |= CAEN_DGTZ_WriteRegister(handle,0x12c4,0x3fff); //fine gain
    
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1238,0x3e8); //pre trigger
    
    ret |= CAEN_DGTZ_WriteRegister(handle,0x125c,0xfa); // trap. rise time
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1260,0x7d); // trap. flat top
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1264,0x25); // peaking time 
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1268,0x4e2); // decay time 

    ret |= CAEN_DGTZ_WriteRegister(handle,0x126c,0x40); //trig. threshold 0x180
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1258,0x24);  //input rise time
