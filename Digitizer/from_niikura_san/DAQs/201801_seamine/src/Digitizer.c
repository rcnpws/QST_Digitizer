...
////end of DAQ setup
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1080,0x20102f0f);  //for positive 
    ret |= CAEN_DGTZ_WriteRegister(handle,0x10c4,0x18ff); //fine gain
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x12c4,0x18ff); //fine gain
...
//printf("entering loop to set individual channel setting \n");
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x8070,125);  //LVDS TRIGGER
