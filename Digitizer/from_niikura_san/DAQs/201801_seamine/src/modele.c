...
const char* GetScalerName(int ch)
{
  ...
  static const char* const SCALER_NAME[32] = {
    "Pla 1",     "Pla 2U",   "Pla 2D",   "Pla 2 coin",
    "beam",  "Pla 3",  "Penetrated" , "SM 1 2",
    "SM 3 4", "SM 5 6",  "SM 7 8",  "SM 9 10",
    "SM 11 12",  "SM 13 14",  "SM 15 16",  "SM 17 18",
    "SM 19 20",  "SM 21",  "SM OR", "BaF 1",
    "BaF 2",   "BaF 3",    "BaF 4",    "BaF 5",
    "BaF 6",   "BaF 7",    "Busy",    "Ge 1",
    "Ge 2",    "Trigger",    "SEC",   "1k Clock"
  };
