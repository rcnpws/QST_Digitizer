...
// Fri Feb 24 11:29:11 2017 by ROOT version 6.06/08
// from TTree tree3/DPP-PHA for ch2
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual Long64_t GetNumberOfEntry();
   virtual Double_t GetEnergy(Long64_t);
...
Int_t Ge2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Ge2::LoadTree(Long64_t entry)
{
