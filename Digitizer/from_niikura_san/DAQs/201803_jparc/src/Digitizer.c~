...
////end of DAQ setup
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x10c4,0x7fff); //fine gain
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1058,0x64);  //input rise time 0x37
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x1280,0x20102f0f);  //for positive
    ...
    ret |= CAEN_DGTZ_WriteRegister(handle,0x126c,0x100); //trig. threshold 0x180
